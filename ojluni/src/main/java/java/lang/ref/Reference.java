...
public abstract class Reference<T> {
    ...
    public static void reachabilityFence(Object ref) {
        ...
        // It will be executed for tests run with --verify-soft-fail.
        // Since this is a volatile store, it cannot easily be moved up past
        // prior accesses, even if this method is inlined.
        SinkHolder.sink = ref;
